    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html "
                target="_blank">
                <img src={{ asset('template-admin/assets/img/logo-ct.png') }} class="navbar-brand-img h-100"
                    alt="main_logo">
                <span class="ms-1 font-weight-bold">P2MW Dashboard</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link  {{ Request::is('userapp*') ? 'active' : '' }}" href="/userapp">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link  {{ Request::is('alats*') ? 'active' : '' }}" href="/alats">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <li class="nav-item">
                    <a class="nav-link  {{ Request::is('history*') ? 'active' : '' }}" href="/history">
                        ...
                        <span class="nav-link-text ms-1">Riwayat Pengguna</span>
                    </a>
                </li>
            </ul>
        </div>
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    @elseif(request()->is('userapp'))
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark"
                                    href="/">Halaman</a></li>
                            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Manajemen
                                Pengguna</li>
                        </ol>
                        <h6 class="font-weight-bolder mb-0">Manajemen Pengguna</h6>
                    @elseif(request()->is('alats'))
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark"
                                    href="/">Halaman</a></li>
                            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Manajemen Alat
                            </li>
                        </ol>
                        <h6 class="font-weight-bolder mb-0">Manajemen Alat</h6>
                    @elseif(request()->is('history'))
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark"
                                    href="/">Halaman</a></li>
                            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Riwayat Pengguna
                            </li>
                        </ol>
                        <h6 class="font-weight-bolder mb-0">Riwayat Pengguna</h6>
                    @endif
                </nav>
