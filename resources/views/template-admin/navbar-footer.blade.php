            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link  {{ Request::is('alats*') ? 'active' : '' }}" href="/alats">
                        ...
                        <span class="nav-link-text ms-1">Alat Management</span>
                    </a>
                </li>
            </ul>
        </div>
                ...
                <nav aria-label="breadcrumb">
                    ...
                    @elseif(request()->is('userapp'))
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            ...
                            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">User Management
                            </li>
                        </ol>
                        <h6 class="font-weight-bolder mb-0">Alat Management</h6>
                    @elseif(request()->is('alats'))
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark"
                                    href="javascript:;">Pages</a>
                            </li>
                            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Alat Management
                            </li>
                        </ol>
                        <h6 class="font-weight-bolder mb-0">Alat Management</h6>
                    @endif
