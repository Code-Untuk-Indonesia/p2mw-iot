                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center">Tool Code</th>
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="align-middle">
                                        <button type="button" class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#editToolModal{{ $alat->id }}">
                                            Edit
                                        </button>
                                ...
                                <!-- Edit Tool Modal -->
                                <div class="modal fade" id="editToolModal{{ $alat->id }}" tabindex="-1" role="dialog" aria-labelledby="editToolModalLabel{{ $alat->id }}" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="editToolModalLabel{{ $alat->id }}">Edit Tool</h5>
                                                ...
                                                <form method="POST" action="{{ route('alats.update', $alat->id) }}">
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <select class="form-control" id="userapps_id" name="userapps_id" required>
                                                            ...
                                                            <option value="{{ $user->UniqueID }}" {{ $alat->userapps_id == $user->UniqueID ? 'selected' : '' }}>
                                                                {{ $user->name }}
                                                            </option>
                                                            @endunless
                                                            @endforeach
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="kodealat" name="kodealat" value="{{ $alat->kodealat }}" required>
                                                    </div>
